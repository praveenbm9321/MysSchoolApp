				...
				<div class="scroller-footer">
					<div class="pull-right">
						<a href="#"> See All Records <i
							class="m-icon-swapright m-icon-gray"></i>
						</a> &nbsp;
					</div>
				</div>
			</div>
							...
							<li>
								...
								<div class="task-title">
									<span class="task-title-sp"> Technical Management
										Meeting </span> <span class="label label-sm label-warning">
										Company </span>
								</div>
								<div class="task-config">
									<div class="task-config-btn btn-group">
							...
							<li>
								...
								<div class="task-title">
									<span class="task-title-sp"> Kick-off Company CRM Mobile
										App Development </span> <span class="label label-sm label-info">
							...
							<li class="last-line">
								...
								<div class="task-title">
									<span class="task-title-sp"> KeenThemes Investment
										Discussion </span> <span class="label label-sm label-warning">
										KeenThemes </span>
								</div>
								<div class="task-config">
									<div class="task-config-btn btn-group">
...
<div class="row ">
	<div class="col-md-6 col-sm-6">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-calendar"></i>Student Performance
				</div>
				<div class="actions">
					<a href="javascript:;"
				...
				<div class="row">
					<div class="col-md-4">
						<div class="easy-pie-chart">
							...
							<a class="title" href="#"> Attendance <i
					...
					<div class="col-md-4">
						<div class="easy-pie-chart">
							...
							<a class="title" href="#"> Marks <i class="m-icon-swapright"></i>
							</a>
						</div>
					</div>
					<div class="margin-bottom-10 visible-sm"></div>
	...
	<div class="col-md-6 col-sm-6">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-calendar"></i>Teacher Performance
				</div>
				<div class="tools">
...
<div class="row ">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="portlet box red">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Time Table
				</div>
				<div class="captions">
					Class <select>

						<c:forEach items="${classes}" var="m">
							<option value="${m.txtClassName}">${m.txtClassName}</option>
						</c:forEach>
					</select>
				</div>
				<div class="captionss">
					Section <select>
						...
						<c:forEach items="${sections}" var="m">
							<option value="${m.txtSectionName}">${m.txtSectionName}</option>
						</c:forEach>
