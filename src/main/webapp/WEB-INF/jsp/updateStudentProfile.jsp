...
<div class="row">
	<div class="col-md-12">
		<form action = "Updated_par_student profile.web" id="form1">
		<%-- <form action="par_student profile.web" > --%>
			<c:forEach items="${studDetail}" var="s">
				<input type="hidden" name="intRegistrationId"
					value="${s.intRegistrationId }">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" class="form-control"
								name="txtPerAddress" value="${s.txtPerAddress} " /></td>
						</tr>

						<%-- <tr>
							<td class="bold">Contact Number (Father):</td>
							<td><input type="text" class="form-control"
								value="${s.txtFmobileNumber}" name="txtFmobileNumber">
							</td>
						</tr> --%>
						<tr>
							<td class="bold">Contact Number (Father):</td>
						...
						<tr>
							...
							<td><input type="text" class="form-control"
								value="${s.txtMmobileNumber}" name="txtMmobileNumber">
							</td>
						</tr>
						<tr>
							<td class="bold">Emergency Contact 1:</td>
							<td><input type="text"  class="form-control"
								value="${s.txtFotherNumber}" name="txtFotherNumber"></td>
						</tr>
						<tr>
							<td class="bold">Emergency Contact 2:</td>
							<td><input type="text"  class="form-control"
								value="${s.txtMotherNumber}" name="txtMotherNumber"></td>
						</tr>
					</tbody>
				</table>
			</c:forEach>
