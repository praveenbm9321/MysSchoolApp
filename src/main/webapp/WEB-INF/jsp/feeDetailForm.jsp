            ...
            <div class="panel-body">
                <form:form id="employeeRegisterForm"  cssClass="form-horizontal" modelAttribute="feemanagement" method="post" action="saveFee"  >
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"> <form:label path="classname" ><b>ClassName<span style="color: red">*</span></b></form:label> </div>
                        <div class="col-xs-6">
                            <form:hidden path="id" value="${feeObject.id}"/>
                            <!--<form:input cssClass="form-control" path="classname" value="${feeObject.classname}"/>-->
                            <form:select cssClass="form-control" name="txtClassName" path="classname"  value="${feeObject.classname}"  >
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="feeamount"><b>FeeAmount<span style="color: red">*</span></b></form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" name="txtFeeAmount" path="feeamount"  value="${feeObject.feeamount}"/>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function submitEmployeeForm() {             
            ...
            if(classname.length ==0) {
                ...
                $('#classname').focus();
                return false;
            }<!--else if(classname=="class1"||classname=="class2"||classname=="class3"||classname=="class4"
                    ||classname=="class5"||classname=="class6"||classname=="class7"||classname=="class8"||classname=="class9"||classname=="class10"){
                alert("Already this Classname exits");
                return false;
            }-->
