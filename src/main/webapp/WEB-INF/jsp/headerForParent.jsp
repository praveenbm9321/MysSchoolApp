		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown user">
				...
				<ul class="dropdown-menu">
						<li><a href="changePasswordForParent.web"> <i class="fa fa-lock"></i> Change password
	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start ">
					<a href="ad_index_For_Parent.web">
						...
						<li id="parStuProfile">
							<a href="par_student profile.web"><!-- ?studentName=Naina"> -->
						...
						<li id = "parQuery">
							<a href="par_question&answer.web">
