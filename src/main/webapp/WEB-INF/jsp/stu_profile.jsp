		...
		<div class="tabbable tabbable-custom tabbable-full-width">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1_1">
					<div class="row">
					<%-- <form action="stu_profile.web" method="post" enctype="multipart/form-data">
						<div class="col-md-3">
							<ul class="list-unstyled profile-nav">
								...
								<c:when test="${! empty m.blImage }">
										...
										<img class="img-responsive"
											...
											<c:otherwise>
											<img src="assets/img/profile/images.jpg" class="img-responsive" alt=""/>
											</c:otherwise>
											</c:choose>
											</c:forEach>
											</li>
						...
						<div class="col-md-8">
							...
							<div class="portlet box green">
								...
								<div class="portlet-title">
									<div class="caption">Personal Identity Information</div>
								</div>
...
<c:forEach items="${mst}" var="m" begin="0" end="0">
										<table class="table table-bordered table-striped">
											<tbody>
												...
												<tr>
													<th>Name</th>
													<td>${m.txtFirstName}  ${m.txtLastName }</td>
												</tr>
												<tr>
													<th>Address</th>
													<td>${m.txtPerAddress}</td>
												</tr>
												<tr>
													<th>Date of Birth</th>
													<td>${m.dtDob}</td>
												...
												<tr>
													<th>Blood Group</th>
													<td>${m.mstbloodgroup.txtBloodGroupName}</td>
												</tr>
												<tr>
													<th>Class</th>
												...
												<tr>
													<th>Father's Name</th>
													<td>${m.txtFatherName}</td>
												</tr>
												<tr>
													<th>Mother's Name</th>
													<td>${m.txtMotherName}</td>
												</tr>
												<tr>
													<th>Contact Number</th>
													<td>${m.txtFotherNumber}</td>
												</tr>
					...
					<div class="tab-pane" id="tab_1_6"></div>
				</div>
				<!--end tab-pane-->
			</div>
		</div>
