							...
							<div class="row">
								<div class="col-md-4">
									<div class="easy-pie-chart">
										...
										<a class="title" href="#">
											 Attendance <i class="m-icon-swapright"></i>
										</a>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="easy-pie-chart">
										...
										<a class="title" href="#">
											Marks <i class="m-icon-swapright"></i>
										</a>
									</div>
								</div>
								<div class="margin-bottom-10 visible-sm">
								...
								<div class="col-md-4">
									<div class="easy-pie-chart">
										...
										<a class="title" href="#">
											 Overall <i class="m-icon-swapright"></i>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="sparkline-chart">
										...
										<a class="title" href="#">
											 Feedback <i class="m-icon-swapright"></i>
										</a>
									</div>
								</div>
								<div class="margin-bottom-10 visible-sm">
						...
						<div class="portlet-body">
							<div class="table-responsive">
								...
								<tr>
									...
									<th>
										 1St Period</br>(9.30 to 10.30)
									</th>
									<th>
										 2nd Period</br>(10.30 to 11.30)
									</th>
									<th>
										 3rd Period</br>(11.30 to 12.30)
									</th>
									<th>
										4th Period</br>(13.30 to 14.30)
									</th>
									<th>
										5th Period</br>(14.30 to 15.30)
									</th>
									<th>
										6th Period</br>(15.30 to 16.30)
									</th>
