        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="#" class="logo"><span><img src="assets1/images/aikshika.png"></span>
                    <i class=<img src="assets1/images/aikshika.png"/>></i></a>
                    <!-- Image logo -->
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                   ...
                                   <!--  <li><a href="javascript:void(0)"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    ...
                                    <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li> -->
                                     <li><a href=" changePasswordForAdmin.web"><i class="ti-lock m-r-5"></i> Change Password</a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-6">
                                ...
                                <form action="admin_profile.web" method="post" id = "form1"
								...
								<ul class="list-unstyled profile-nav">
													...
													<div class="card-box widget-box-one">
														<center>
															<img class="img-responsive" style="width:550px;height: 330px;"
																src="getUserImages/<c:out value="${m.intRegistrationId}"/>.web">
														</center>
													</div>
												</c:when>
									...
									<div align="center">
										<div class="input-group">
										 ...
										 <input type="file" name="blAttachment" class="form-control"
												placeholder="upload">
									...
									<div class="col-md-offset-3 col-md-9">
										...
										<p>
											Only (<strong>.jpg, .jpeg and .png</strong>)
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <a data-toggle="dropdown" class="dropdown-toggle menu-item" href="#" aria-expanded="false"><img src="assets1/images/usermanagement.png">
                                    </a>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="ad_reg.web"><img src="assets1/images/newregistration.png"></a></li>
                                    <li><a href="user_staff.web"><img src="assets1/images/Staff_Student Master Record.png"></a></li>
                                    <li><a href="ad_assignClass.web"><img src="assets1/images/assignclassteacher.png"></a></li>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                              <center><div class="card-box widget-box-one">
                                    <!--<center><a href="attendance.web"><img src="assets1/images/attendance.png"</a></center>-->
                                     <li class="dropdown hidden-xs">
                                <a data-toggle="dropdown" class="dropdown-toggle menu-item" href="#" aria-expanded="false"><img src="assets1/images/attendence&leave.png">
                                    </a>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="ad_attendance.web"><img src="assets1/images/Attendence Info.png"></a></li>
                                    <li><a href="ad_teach_attend.web"><img src="assets1/images/Teacher Info.png"></a></li>
									<li><a href="ad_leaveInfo.web"><img src="assets1/images/Leave Info.png"></a></li>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_library.web"><img src="assets1/images/library.png"></a></center>
                                </div>
                            </div><!-- end col -->
                            
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_timetable.web"><img src="assets1/images/timetable.png"></a></center>
                                </div>
                            </div><!-- end col -->
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_invites.web"><img src="assets1/images/invites.png"></a></center>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <center><a href="fin_fee management.web"><img src="assets1/images/feemanagement.png"></a></center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_school's_connect.web"><img src="assets1/images/SchoolConnect.png"></a></center>
                                </div>
                            </div><!-- end col -->

                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_query.web"><img src="assets1/images/Queries.png"></a></center>
                                </div>
                            </div><!-- end col -->
                            
                           <%--  <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_school & branch.web"><img src="assets1/images/School & Branch Details.png"></a></center>
                                </div>
                            </div> --%><!-- end col -->

                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="ad_syllabus.web"><img src="assets1/images/syllabus.png"></a></center>
                                </div>
                            </div>
