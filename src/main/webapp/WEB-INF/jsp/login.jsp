...
<!-- BEGIN BODY -->
<body class="login" onload="javascript:back_block();">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="login-form" action="check.web"  method="post" id="form1">
			<h3 class="form-title">Login to your account</h3>


			<c:if test="${not empty msg2}">
				<strong style="color: blue;">${msg2}</strong>
			</c:if>
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-user"></i> <input
						...
						autocomplete="off" placeholder="User Name" name="uname" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="forget-password">
				...
				<p>
					...
					<a href = "EnterNameNumber.web" >click here </a> to
					reset your password.
			</div>
		...
		<!-- <form class="forget-form" action="login.web" method="post">
		...
		<form class="register-form" action="index.html" method="post">
			...
			<div class="form-group">
				...
				<select name="country" id="select2_sample4"
			...
			<div class="form-group">
				<label> <input type="checkbox" name="tnc" /> I agree to the
					<a href="#"> Terms of Service </a> and <a href="#"> Privacy
						Policy </a>
				</label>
