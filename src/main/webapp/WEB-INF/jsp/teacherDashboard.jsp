<!DOCTYPE html>
<html>
    <head> <script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.1.1.min.js"></script>
        <meta charset="utf-8">
...
#form1 .error{
                        ...
                        <ul class="nav navbar-nav navbar-right">
							...
							%></a>
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li><a href="changePasswordForTeacher.web"><i class="ti-lock m-r-5"></i> Change Password</a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-6">
                                ...
                                <form action="teacher_profile.web" method="post" id = "form1"
													...
													<div class="card-box widget-box-one">
														<center>
															<img class="img-responsive" style="width:550px;height: 330px;"
																src="getUserImagee/<c:out value="${m.intRegistrationId}"/>.web">
														</center>
													</div>
												</c:when>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_profile.web"><img src="assets1/images/profile.png"></a></center>
                                </div>
                            </div><!-- end col -->
                           ...
                           <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="teac_leave request.web"><img src="assets1/images/Leave Application.png"></a></li>
                                    <li><a href="teac_leaveInbox.web"><img src="assets1/images/Leave Inbox.png"></a></li>
									<li><a href="teac_StudentLeaveInbox.web"><img src="assets1/images/Student Leave Approval Inbox.png"></a></li>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_question & answer.web"><img src="assets1/images/Q&A copy.png"></a></center>
                                </div>
                            </div><!-- end col -->
 ...
 <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_homework.web"><img src="assets1/images/homework.png"></a></center>
                                </div>
                            </div><!-- end col -->
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <center><a href="teac_marksheet.web"><img src="assets1/images/Student Marks Sheet.png"></a></center>
                        		...
                        		<div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_timetable.web"><img src="assets1/images/timetable.png"></a></center>
                                </div>
                            </div><!-- end col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_send invites.web"><img src="assets1/images/invites.png"></a></center>
                                </div>
                            </div><!-- end col -->

                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_project.web"><img src="assets1/images/project.png"></a></center>
                                </div>
                            </div><!-- end col -->
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <center><a href="teac_notification.web"><img src="assets1/images/invitation.png"></a></center>
                                </div>
                            </div><!-- end col -->
