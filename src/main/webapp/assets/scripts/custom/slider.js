function slider(id) {
	...
	else if (id == 6) {// Admin leave info
		// $("#Admin").addClass('active');
		$("#attendanceLeave").addClass('active');
		$("#leaveInfo").addClass('active');
	}
	...
	else if (id == 15) {// Admin teacher attend track
		// $("#Admin").addClass('active');
		$("#attendanceLeave").addClass('active');
		$("#teachAttendInfo").addClass('active');
	} else if (id == 16) {// Admin teacher attend track
		// $("#Admin").addClass('active');

		$("#adminQuery").addClass('active');
	}

	else if (id == 17) {// Admin teacher attend track
		// $("#Admin").addClass('active');
		$("#usermanagement").addClass('active');
		$("#assignCT").addClass('active');
	}

	else if (id == 18) {// Admin invites
		// $("#Admin").addClass('active');
		$("#invites").addClass('active');
		$("#teacherInvites").addClass('active');
	}
	...
	} else if (id == 212) {// parent lib
		// $("#Parent").addClass('active');
		$("#parSyllabus").addClass('active');
	}

	else if (id == 213) {// parent query
		// $("#Parent").addClass('active');
		$("#parQuery").addClass('active');
	}
	...
	} else if (id == 302) {// student attendance
		// $("#Student").addClass('active');
		$("#stuAttendance").addClass('active');
	} else if (id == 303) {// student task
		// $("#Student").addClass('active');
		$("#stuTask").addClass('active');
	} else if (id == 304) {// student notification
		// $("#Student").addClass('active');
		$("#stuNotification").addClass('active');
	} else if (id == 305) {// student question&Answer
		// $("#Student").addClass('active');
		$("#stuQuesAns").addClass('active');
	} else if (id == 306) {// student marks
		// $("#Student").addClass('active');
		$("#stuMarks").addClass('active');
	} else if (id == 307) {// student timetable
		// $("#Student").addClass('active');
		$("#stuTimetable").addClass('active');
	} else if (id == 308) {// student syllabus
		// $("#Student").addClass('active');
		$("#stuSyllabus").addClass('active');
	}
	// student module end---------
